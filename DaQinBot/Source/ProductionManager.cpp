...
void ProductionManager::manageBuildOrderQueue()
{
	...
	while (!_queue.isEmpty()) 
	{
		...
		if (_outOfBook && currentItem.macroAct.isUnit())
		{
            ...
            {
                int robos = UnitUtil::GetCompletedUnitCount(BWAPI::UnitTypes::Protoss_Robotics_Facility) + BuildingManager::Instance().getNumBeingBuilt(BWAPI::UnitTypes::Protoss_Robotics_Facility);
